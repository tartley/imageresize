...
from os.path import basename, dirname, getsize, isdir, isfile, join, splitext
from shutil import copy
from sys import argv, exit

import Image

_revision="$Revision: 12 $"
revision=int(_revision.split(' ')[1])
...
""" % (revision, defaultSize, backupDir)
